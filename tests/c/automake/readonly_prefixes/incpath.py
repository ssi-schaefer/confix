...
class IncludePathInMemorySuite(unittest.TestSuite):
    def __init__(self):
        unittest.TestSuite.__init__(self)
        self.addTest(IncludePathInMemoryTest('test'))
        pass
    pass

class IncludePathInMemoryTest(unittest.TestCase):
    def test(self):
...
if __name__ == '__main__':
    unittest.TextTestRunner().run(IncludePathInMemorySuite())
    pass
