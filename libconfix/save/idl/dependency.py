# $Id: dependency.py,v 1.2 2006/03/22 15:03:54 jfasch Exp $
...
from libconfix.core.marshalling import Marshallable, update_marshalling_data
...
class Require_IDL(Require_String):
    ...
    def __init__(self, filename, found_in, urgency):
        ...
        fn = libconfix.helper.normalize_filename(filename)
...
class Provide_IDL(Provide_String):
    ...
    def __init__(self, filename, match=EXACT_MATCH):
        ...
        Provide_String.__init__(self,
                                string=libconfix.helper.normalize_filename(filename),
                                match=match)

    def __repr__(self):
        return "IDL: "+self.string()
