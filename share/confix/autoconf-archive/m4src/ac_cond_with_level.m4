...
dnl the definition is set to a numeric value. The level of a simple
dnl "yes" is given (or assumed "2" if absent), otherwise the level can
dnl be given in mnemonic names, being 1 = some 2 = many 3 = all 4 =
dnl extra 5 = extrasome more 6 = extramany muchmore much 7 = super
dnl everything 8 = ultra experimental 9 = insane
dnl
