...
dnl
dnl @summary Checks if the given list of 'Module Version' are avaiable
dnl
dnl Checks to see if the list of 'Module Version' are avaiable in the
dnl system. If all the modules in the list are avaiable ACTION-IF-TRUE
dnl is executed. Case one module is not avaiable ACTION-IF-FALSE is
dnl executed and the macro execution is aborted. NOTE: Perl is needed.
dnl
dnl Example:
dnl
dnl   AC_PERL_MODULE_VERSION(CGI::Test 0.104 CGI::Ajax 0.694, ,
dnl      AC_MSG_ERROR(Need some Perl modules))
dnl
dnl @category InstalledPackages
dnl @author Marco Gomes <mpglesi@gmail.com>
dnl @author Ruben Fonseca <fonseka@gmail.com>
dnl @version 2006-05-12
