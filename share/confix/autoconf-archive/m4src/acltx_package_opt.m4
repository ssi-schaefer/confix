dnl @synopsis ACLTX_PACKAGE_OPT(PACKAGENAME,CLASSNAME,VARIABLETOSET,PARAMETER[,ACTION-IF-FOUND[,ACTION-IF-NOT-FOUND]])
dnl
dnl This package do the same thing as ACLTX_PACKAGE, except, that
dnl PARAMETER is optional parameter for the package
dnl
dnl @category LaTeX
