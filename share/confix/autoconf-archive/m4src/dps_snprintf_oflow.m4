dnl @synopsis dps_snprintf_oflow
dnl
dnl Checks whether snprintf ignores the value of n or not and defines
dnl HAVE_SNPRINTF_BUG if it does.
dnl
dnl @category C
dnl @author Duncan Simpson <dps@io.stargate.co.uk>
