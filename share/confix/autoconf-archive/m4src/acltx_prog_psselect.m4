dnl @synopsis ACLTX_PROG_PSSELECT([ACTION-IF-NOT-FOUND])
dnl
dnl This macro find a psselect application and set the variable
dnl psselect to the name of the application or to no if not found if
